...
export const links: MenuItem[] = [
  {
    ...
    sublinks: [
      { name: "swap", link: "/swap", onClick: null },
      { name: "bridge", link: "/bridge", onClick: null },
    ],
  },
  {
    name: "Audits",
    ...
    sublinks: [
      {
        name: "Cyberscope",
        link: "https://github.com/cyberscope-io/audits/blob/main/agata/audit.pdf",
        onClick: null,
      },
      {
        name: "Checkdot",
        link: "https://audits.checkdot.io/Agata-Audit-CheckDot.pdf",
        onClick: null,
      },
    ],
