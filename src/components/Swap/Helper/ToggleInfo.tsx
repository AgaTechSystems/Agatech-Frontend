          ...
          <div className="pt-3 swap_autoheight space-y-2 mr-1">
                ...
                <div className={`flex flex-row items-center`}>
                  {route_sources?.some((e) => e.name == "MultiHop")
                    ...
                    : route_sources?.map((e, indx) => (
                        ...
                        >
                          <Image
                            className="rounded-[6px] w-[20px] h-[20px] outline ring-1 ring-black ring-opacity-25 outline-offset-[-1px]"
            ...
            <div className={textLine}>
              ...
              {loading ? (
                ...
                <span>
                $
                {nativePrice && estimatedGas !== null && (
                  (Number(((Number(estimatedGas) / 10 ** 9) * nativePrice).toFixed(3)) < 0.01 
                    ? ' <0.01' 
